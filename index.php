    ...
    <div class="wrapper">
        <div class="sidebar">
            ...
            <ul>
                ...
                <div class="suaconta">
                    <div class="center">
                        <li class="li-conta"><a href="cadastro.php">Meu Perfil</a></li>
        ...
        <div class="main_content">
            <div class="header">
                <div class="wrap">
                    <div class="search2">
                        <form method="GET" action="subpagina/pesquisa.php">
                        <input type="text"name="nome_livro"class="searchTerm" placeholder="Pesquisar">
            ...
            <?php
            echo "<div class='center'><h4> Resultados para: $nome </h4></div>";
